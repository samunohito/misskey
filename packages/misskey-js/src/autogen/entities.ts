...
export type AdminDriveSystemExploreRequest = operations['admin___drive___system___explore']['requestBody']['content']['application/json'];
export type AdminDriveSystemExploreResponse = operations['admin___drive___system___explore']['responses']['200']['content']['application/json'];
export type AdminDriveSystemFilesCreateRequest = operations['admin___drive___system___files___create']['requestBody']['content']['multipart/form-data'];
export type AdminDriveSystemFilesCreateResponse = operations['admin___drive___system___files___create']['responses']['200']['content']['application/json'];
export type AdminDriveSystemFilesDeleteRequest = operations['admin___drive___system___files___delete']['requestBody']['content']['application/json'];
export type AdminDriveSystemFilesSearchRequest = operations['admin___drive___system___files___search']['requestBody']['content']['application/json'];
export type AdminDriveSystemFilesSearchResponse = operations['admin___drive___system___files___search']['responses']['200']['content']['application/json'];
export type AdminDriveSystemFilesUpdateRequest = operations['admin___drive___system___files___update']['requestBody']['content']['application/json'];
export type AdminDriveSystemFilesUpdateResponse = operations['admin___drive___system___files___update']['responses']['200']['content']['application/json'];
export type AdminDriveSystemFoldersCreateRequest = operations['admin___drive___system___folders___create']['requestBody']['content']['application/json'];
export type AdminDriveSystemFoldersCreateResponse = operations['admin___drive___system___folders___create']['responses']['200']['content']['application/json'];
export type AdminDriveSystemFoldersDeleteRequest = operations['admin___drive___system___folders___delete']['requestBody']['content']['application/json'];
export type AdminDriveSystemFoldersSearchRequest = operations['admin___drive___system___folders___search']['requestBody']['content']['application/json'];
export type AdminDriveSystemFoldersSearchResponse = operations['admin___drive___system___folders___search']['responses']['200']['content']['application/json'];
export type AdminDriveSystemFoldersUpdateRequest = operations['admin___drive___system___folders___update']['requestBody']['content']['application/json'];
export type AdminDriveSystemFoldersUpdateResponse = operations['admin___drive___system___folders___update']['responses']['200']['content']['application/json'];
export type AdminDriveSystemFoldersPwdRequest = operations['admin___drive___system___folders___pwd']['requestBody']['content']['application/json'];
export type AdminDriveSystemFoldersPwdResponse = operations['admin___drive___system___folders___pwd']['responses']['200']['content']['application/json'];

...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(@inject(delay(() => ChatService)) private chatService: ChatService, @inject(delay(() => RoleService)) private roleService: RoleService, @inject(delay(() => ChatEntityService)) private chatEntityService: ChatEntityService) {

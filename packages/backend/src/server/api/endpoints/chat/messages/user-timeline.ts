...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(@inject(delay(() => ChatEntityService)) private chatEntityService: ChatEntityService, @inject(delay(() => ChatService)) private chatService: ChatService, @inject(delay(() => GetterService)) private getterService: GetterService, @inject(delay(() => IdService)) private idService: IdService) {

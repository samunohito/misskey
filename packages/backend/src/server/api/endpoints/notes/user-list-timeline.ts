...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(
		...
		private userListMembershipsRepository: UserListMembershipsRepository,@inject(delay(() => NoteEntityService)) private noteEntityService: NoteEntityService,@inject(delay(() => ActiveUsersChart)) private activeUsersChart: ActiveUsersChart,@inject(delay(() => IdService)) private idService: IdService,@inject(delay(() => FanoutTimelineEndpointService)) private fanoutTimelineEndpointService: FanoutTimelineEndpointService,@inject(delay(() => QueryService)) private queryService: QueryService,@inject(delay(() => ChannelMutingService)) private channelMutingService: ChannelMutingService) {

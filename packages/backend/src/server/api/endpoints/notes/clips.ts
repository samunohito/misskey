...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(
		...
		private clipNotesRepository: ClipNotesRepository, @inject(delay(() => ClipEntityService)) private clipEntityService: ClipEntityService, @inject(delay(() => GetterService)) private getterService: GetterService) {

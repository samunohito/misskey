...
export class ServerService implements Disposable {
	...
	constructor(
		...
		@inject(delay(() => ApiServerService))
		private apiServerService: ApiServerService,

		@inject(delay(() => OpenApiServerService))
		private openApiServerService: OpenApiServerService,

		@inject(delay(() => StreamingApiServerService))
		private streamingApiServerService: StreamingApiServerService,

		@inject(delay(() => ActivityPubServerService))
		private activityPubServerService: ActivityPubServerService,

		@inject(delay(() => WellKnownServerService))
		private wellKnownServerService: WellKnownServerService,

		@inject(delay(() => NodeinfoServerService))
		private nodeinfoServerService: NodeinfoServerService,

		@inject(delay(() => FileServerService))
		private fileServerService: FileServerService,

		@inject(delay(() => HealthServerService))
		private healthServerService: HealthServerService,

		@inject(delay(() => ClientServerService))

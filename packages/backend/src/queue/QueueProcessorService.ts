...
export class QueueProcessorService implements Disposable {
	...
	constructor(
		...
		@inject(delay(() => UserWebhookDeliverProcessorService))
		private userWebhookDeliverProcessorService: UserWebhookDeliverProcessorService,

		@inject(delay(() => SystemWebhookDeliverProcessorService))
		private systemWebhookDeliverProcessorService: SystemWebhookDeliverProcessorService,

		@inject(delay(() => EndedPollNotificationProcessorService))
		private endedPollNotificationProcessorService: EndedPollNotificationProcessorService,

		@inject(delay(() => PostScheduledNoteProcessorService))
		private postScheduledNoteProcessorService: PostScheduledNoteProcessorService,

		@inject(delay(() => DeliverProcessorService))
		private deliverProcessorService: DeliverProcessorService,

		@inject(delay(() => InboxProcessorService))
		private inboxProcessorService: InboxProcessorService,

		@inject(delay(() => DeleteDriveFilesProcessorService))
		private deleteDriveFilesProcessorService: DeleteDriveFilesProcessorService,

		@inject(delay(() => ExportCustomEmojisProcessorService))
		private exportCustomEmojisProcessorService: ExportCustomEmojisProcessorService,

		@inject(delay(() => ExportNotesProcessorService))
		private exportNotesProcessorService: ExportNotesProcessorService,

		@inject(delay(() => ExportClipsProcessorService))
		private exportClipsProcessorService: ExportClipsProcessorService,

		@inject(delay(() => ExportFavoritesProcessorService))
		private exportFavoritesProcessorService: ExportFavoritesProcessorService,

		@inject(delay(() => ExportFollowingProcessorService))
		private exportFollowingProcessorService: ExportFollowingProcessorService,

		@inject(delay(() => ExportMutingProcessorService))
		private exportMutingProcessorService: ExportMutingProcessorService,

		@inject(delay(() => ExportBlockingProcessorService))
		private exportBlockingProcessorService: ExportBlockingProcessorService,

		@inject(delay(() => ExportUserListsProcessorService))
		private exportUserListsProcessorService: ExportUserListsProcessorService,

		@inject(delay(() => ExportAntennasProcessorService))
		private exportAntennasProcessorService: ExportAntennasProcessorService,

		@inject(delay(() => ImportFollowingProcessorService))
		private importFollowingProcessorService: ImportFollowingProcessorService,

		@inject(delay(() => ImportMutingProcessorService))
		private importMutingProcessorService: ImportMutingProcessorService,

		@inject(delay(() => ImportBlockingProcessorService))
		private importBlockingProcessorService: ImportBlockingProcessorService,

		@inject(delay(() => ImportUserListsProcessorService))
		private importUserListsProcessorService: ImportUserListsProcessorService,

		@inject(delay(() => ImportCustomEmojisProcessorService))
		private importCustomEmojisProcessorService: ImportCustomEmojisProcessorService,

		@inject(delay(() => ImportAntennasProcessorService))
		private importAntennasProcessorService: ImportAntennasProcessorService,

		@inject(delay(() => DeleteAccountProcessorService))
		private deleteAccountProcessorService: DeleteAccountProcessorService,

		@inject(delay(() => DeleteFileProcessorService))
		private deleteFileProcessorService: DeleteFileProcessorService,

		@inject(delay(() => CleanRemoteFilesProcessorService))
		private cleanRemoteFilesProcessorService: CleanRemoteFilesProcessorService,

		@inject(delay(() => RelationshipProcessorService))
		private relationshipProcessorService: RelationshipProcessorService,

		@inject(delay(() => TickChartsProcessorService))
		private tickChartsProcessorService: TickChartsProcessorService,

		@inject(delay(() => ResyncChartsProcessorService))
		private resyncChartsProcessorService: ResyncChartsProcessorService,

		@inject(delay(() => CleanChartsProcessorService))
		private cleanChartsProcessorService: CleanChartsProcessorService,

		@inject(delay(() => AggregateRetentionProcessorService))
		private aggregateRetentionProcessorService: AggregateRetentionProcessorService,

		@inject(delay(() => CheckExpiredMutingsProcessorService))
		private checkExpiredMutingsProcessorService: CheckExpiredMutingsProcessorService,

		@inject(delay(() => BakeBufferedReactionsProcessorService))
		private bakeBufferedReactionsProcessorService: BakeBufferedReactionsProcessorService,

		@inject(delay(() => CheckModeratorsActivityProcessorService))
		private checkModeratorsActivityProcessorService: CheckModeratorsActivityProcessorService,

		@inject(delay(() => CleanProcessorService))
		private cleanProcessorService: CleanProcessorService,

		@inject(delay(() => CleanRemoteNotesProcessorService))

...
export class ApInboxService {
	...
	constructor(
		...
		private followRequestsRepository: FollowRequestsRepository, @inject(delay(() => UserEntityService)) private userEntityService: UserEntityService, @inject(delay(() => NoteEntityService)) private noteEntityService: NoteEntityService, @inject(delay(() => UtilityService)) private utilityService: UtilityService, @inject(delay(() => IdService)) private idService: IdService, @inject(delay(() => AbuseReportService)) private abuseReportService: AbuseReportService, @inject(delay(() => UserFollowingService)) private userFollowingService: UserFollowingService, @inject(delay(() => ApAudienceService)) private apAudienceService: ApAudienceService, @inject(delay(() => ReactionService)) private reactionService: ReactionService, @inject(delay(() => RelayService)) private relayService: RelayService, @inject(delay(() => NotePiningService)) private notePiningService: NotePiningService, @inject(delay(() => UserBlockingService)) private userBlockingService: UserBlockingService, @inject(delay(() => NoteCreateService)) private noteCreateService: NoteCreateService, @inject(delay(() => NoteDeleteService)) private noteDeleteService: NoteDeleteService, @inject(delay(() => ApResolverService)) private apResolverService: ApResolverService, @inject(delay(() => ApDbResolverService)) private apDbResolverService: ApDbResolverService, @inject(delay(() => ApLoggerService)) private apLoggerService: ApLoggerService, @inject(delay(() => ApNoteService)) private apNoteService: ApNoteService, @inject(delay(() => ApPersonService)) private apPersonService: ApPersonService, @inject(delay(() => ApQuestionService)) private apQuestionService: ApQuestionService, @inject(delay(() => QueueService)) private queueService: QueueService, @inject(delay(() => GlobalEventService)) private globalEventService: GlobalEventService) {
